...
function HomePage() {
  return (
    <div>
      ...
      <div className="my-8 mr-80 min-w-md outline outline-2 outline-(--accent-cyan)/40 p-5 pb-10 rounded-xl bg-(--bg)/80">
        ...
        <p>also, it’s fun to make a custom website just for yourself, even if it’s likely not many people 
          will see it.</p>
        <br/>
        <p>feel free to poke around. i hope you enjoy your time here!</p>
      </div>
    </div>
  )
}
